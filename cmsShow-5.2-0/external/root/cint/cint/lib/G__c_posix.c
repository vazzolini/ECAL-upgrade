...
{
      G__letint(result7, 105, (long) fchown((int) G__int(libp->para[0]), (int) G__int(libp->para[1])
...
void G__c_setup_typetable() {
   ...
   G__setnewtype(-2,NULL,0);
   G__search_typename2("mode_t",114,-1,0,-1);
   G__setnewtype(-2,NULL,0);
   G__search_typename2("time_t",108,-1,0,-1);
   G__setnewtype(-2,NULL,0);
   G__search_typename2("umode_t",114,-1,0,-1);
   G__setnewtype(-2,NULL,0);
...
static void G__setup_memvarstat(void) {
   ...
   G__memvar_setup((void*)((long)(&p->st_dev)-(long)(p)),104,0,0,-1,G__defined_typename("dev_t"),-1,1,"st_dev=",0,(char*)NULL);
   G__memvar_setup((void*)((long)(&p->st_ino)-(long)(p)),107,0,0,-1,G__defined_typename("ino_t"),-1,1,"st_ino=",0,(char*)NULL);
   G__memvar_setup((void*)((long)(&p->st_mode)-(long)(p)),114,0,0,-1,G__defined_typename("umode_t"),-1,1,"st_mode=",0,(char*)NULL);
   G__memvar_setup((void*)((long)(&p->st_nlink)-(long)(p)),114,0,0,-1,G__defined_typename("nlink_t"),-1,1,"st_nlink=",0,(char*)NULL);
   ...
   G__memvar_setup((void*)((long)(&p->st_rdev)-(long)(p)),104,0,0,-1,G__defined_typename("dev_t"),-1,1,"st_rdev=",0,(char*)NULL);
...
static void G__cpp_setup_global0() {
   ...
   G__memvar_setup((void*)G__PVOID,112,0,0,-1,-1,-1,1,"__GNUC_MINOR__=6",1,(char*)NULL);
...
, funcptr._read, 0);
   ...
   funcptr._write = 0;
#endif
   G__memfunc_setup("S_ISREG", 556, G__posix__0_11, 105, -1, -1, 0, 1, 1, 1, 0, "r - 'mode_t' 0 - m", (char*) NULL
, funcptr._read, 0);
#ifndef S_ISDIR
   ...
   funcptr._write = 0;
#endif
   G__memfunc_setup("S_ISDIR", 557, G__posix__0_12, 105, -1, -1, 0, 1, 1, 1, 0, "r - 'mode_t' 0 - m", (char*) NULL
, funcptr._read, 0);
#ifndef S_ISCHR
   ...
   funcptr._write = 0;
#endif
   G__memfunc_setup("S_ISCHR", 555, G__posix__0_13, 105, -1, -1, 0, 1, 1, 1, 0, "r - 'mode_t' 0 - m", (char*) NULL
, funcptr._read, 0);
#ifndef S_ISBLK
   ...
   funcptr._write = 0;
#endif
   G__memfunc_setup("S_ISBLK", 551, G__posix__0_14, 105, -1, -1, 0, 1, 1, 1, 0, "r - 'mode_t' 0 - m", (char*) NULL
, funcptr._read, 0);
#ifndef S_ISFIFO
   ...
   funcptr._write = 0;
#endif
   G__memfunc_setup("S_ISFIFO", 626, G__posix__0_15, 105, -1, -1, 0, 1, 1, 1, 0, "r - 'mode_t' 0 - m", (char*) NULL
, funcptr._read, 0);
#ifndef uname
...
, funcptr._read, 0);
   ...
   funcptr._write = 0;
#endif
   G__memfunc_setup("pause", 542, G__posix__0_25, 105, -1, -1, 0, 0, 1, 1, 0, "", (char*) NULL
, funcptr._read, 0);
#ifndef chown
   ...
   funcptr._write = 0;
#endif
   G__memfunc_setup("chown", 543, G__posix__0_26, 105, -1, -1, 0, 3, 1, 1, 0, 
...
, funcptr._read, 0);
   ...
   funcptr._write = 0;
#endif
   G__memfunc_setup("chdir", 522, G__posix__0_27, 105, -1, -1, 0, 1, 1, 1, 0, "C - - 10 - path", (char*) NULL
, funcptr._read, 0);
#ifndef getcwd
   ...
   funcptr._write = 0;
#endif
   G__memfunc_setup("getcwd", 638, G__posix__0_28, 67, -1, -1, 0, 2, 1, 1, 0, 
...
, funcptr._read, 0);
   ...
   funcptr._write = 0;
#endif
   G__memfunc_setup("sysconf", 773, G__posix__0_29, 108, -1, -1, 0, 1, 1, 1, 0, "i - - 0 - name", (char*) NULL
, funcptr._read, 0);
#ifndef putenv
   ...
   funcptr._write = 0;
#endif
   G__memfunc_setup("putenv", 674, G__posix__0_30, 105, -1, -1, 0, 1, 1, 1, 0, "C - - 0 - string", (char*) NULL
, funcptr._read, 0);
#ifndef getpid
   ...
   funcptr._write = 0;
#endif
   G__memfunc_setup("getpid", 637, G__posix__0_31, 105, -1, G__defined_typename("pid_t"), 0, 0, 1, 1, 0, "", (char*) NULL
, funcptr._read, 0);
#ifndef getppid
   ...
   funcptr._write = 0;
#endif
   G__memfunc_setup("getppid", 749, G__posix__0_32, 105, -1, G__defined_typename("pid_t"), 0, 0, 1, 1, 0, "", (char*) NULL
, funcptr._read, 0);
#ifndef setpgid
   ...
   funcptr._write = 0;
#endif
   G__memfunc_setup("setpgid", 752, G__posix__0_33, 105, -1, -1, 0, 2, 1, 1, 0, 
...
, funcptr._read, 0);
   ...
   funcptr._write = 0;
#endif
   G__memfunc_setup("getpgrp", 761, G__posix__0_34, 105, -1, G__defined_typename("pid_t"), 0, 0, 1, 1, 0, "", (char*) NULL
, funcptr._read, 0);
#ifndef getuid
   ...
   funcptr._write = 0;
#endif
   G__memfunc_setup("getuid", 642, G__posix__0_35, 104, -1, G__defined_typename("uid_t"), 0, 0, 1, 1, 0, "", (char*) NULL
, funcptr._read, 0);
#ifndef geteuid
   ...
   funcptr._write = 0;
#endif
   G__memfunc_setup("geteuid", 743, G__posix__0_36, 104, -1, G__defined_typename("uid_t"), 0, 0, 1, 1, 0, "", (char*) NULL
, funcptr._read, 0);
#ifndef getgid
   ...
   funcptr._write = 0;
#endif
   G__memfunc_setup("getgid", 628, G__posix__0_37, 104, -1, G__defined_typename("gid_t"), 0, 0, 1, 1, 0, "", (char*) NULL
, funcptr._read, 0);
#ifndef getegid
   ...
   funcptr._write = 0;
#endif
   G__memfunc_setup("getegid", 729, G__posix__0_38, 104, -1, G__defined_typename("gid_t"), 0, 0, 1, 1, 0, "", (char*) NULL
, funcptr._read, 0);
#ifndef setuid
   ...
   funcptr._write = 0;
#endif
   G__memfunc_setup("setuid", 654, G__posix__0_39, 105, -1, -1, 0, 1, 1, 1, 0, "h - 'uid_t' 0 - uid", (char*) NULL
, funcptr._read, 0);
#ifndef getlogin
   ...
   funcptr._write = 0;
#endif
   G__memfunc_setup("getlogin", 857, G__posix__0_40, 67, -1, -1, 0, 0, 1, 1, 0, "", (char*) NULL
, funcptr._read, 0);
#ifndef ctermid
   ...
   funcptr._write = 0;
#endif
   G__memfunc_setup("ctermid", 744, G__posix__0_41, 67, -1, -1, 0, 1, 1, 1, 0, "C - - 0 - s", (char*) NULL
, funcptr._read, 0);
#ifndef ttyname
   ...
   funcptr._write = 0;
#endif
   G__memfunc_setup("ttyname", 770, G__posix__0_42, 67, -1, -1, 0, 1, 1, 1, 0, "i - - 0 - desc", (char*) NULL
, funcptr._read, 0);
#ifndef link
   ...
   funcptr._write = 0;
#endif
   G__memfunc_setup("link", 430, G__posix__0_43, 105, -1, -1, 0, 2, 1, 1, 0, 
...
, funcptr._read, 0);
   ...
   funcptr._write = 0;
#endif
   G__memfunc_setup("unlink", 657, G__posix__0_44, 105, -1, -1, 0, 1, 1, 1, 0, "C - - 10 - pathname", (char*) NULL
, funcptr._read, 0);
#ifndef rmdir
   ...
   funcptr._write = 0;
#endif
   G__memfunc_setup("rmdir", 542, G__posix__0_45, 105, -1, -1, 0, 1, 1, 1, 0, "C - - 10 - path", (char*) NULL
, funcptr._read, 0);
#ifndef mkdir
   ...
   funcptr._write = 0;
#endif
   G__memfunc_setup("mkdir", 535, G__posix__0_46, 105, -1, -1, 0, 2, 1, 1, 0, 
"C - - 10 - pathname r - 'mode_t' 0 - mode", (char*) NULL
, funcptr._read, 0);
#ifndef fork
   ...
   funcptr._write = 0;
#endif
   G__memfunc_setup("fork", 434, G__posix__0_47, 105, -1, G__defined_typename("pid_t"), 0, 0, 1, 1, 0, "", (char*) NULL
, funcptr._read, 0);
#ifndef time
   ...
   funcptr._write = 0;
#endif
   G__memfunc_setup("time", 431, G__posix__0_48, 108, -1, G__defined_typename("time_t"), 0, 1, 1, 1, 0, "L - 'time_t' 0 - t", (char*) NULL
, funcptr._read, 0);
#ifndef S_ISLNK
   ...
   funcptr._write = 0;
#endif
   G__memfunc_setup("S_ISLNK", 563, G__posix__0_49, 105, -1, -1, 0, 1, 1, 1, 0, "r - 'mode_t' 0 - m", (char*) NULL
, funcptr._read, 0);
#ifndef S_ISSOCK
   ...
   funcptr._write = 0;
#endif
   G__memfunc_setup("S_ISSOCK", 638, G__posix__0_50, 105, -1, -1, 0, 1, 1, 1, 0, "r - 'mode_t' 0 - m", (char*) NULL
, funcptr._read, 0);
#ifndef fchown
   ...
   funcptr._write = 0;
#endif
   G__memfunc_setup("fchown", 645, G__posix__0_51, 105, -1, -1, 0, 3, 1, 1, 0, 
"i - - 0 - fd i - - 0 - owner i - - 0 - group", (char*) NULL
, funcptr._read, 0);
#ifndef fchdir
   ...
   funcptr._write = 0;
#endif
   G__memfunc_setup("fchdir", 624, G__posix__0_52, 105, -1, -1, 0, 1, 1, 1, 0, "i - - 0 - fd", (char*) NULL
, funcptr._read, 0);
#ifndef setpgrp
   ...
   funcptr._write = 0;
#endif
   G__memfunc_setup("setpgrp", 773, G__posix__0_53, 105, -1, G__defined_typename("pid_t"), 0, 0, 1, 1, 0, "", (char*) NULL
, funcptr._read, 0);
#ifndef symlink
   ...
   funcptr._write = 0;
#endif
   G__memfunc_setup("symlink", 775, G__posix__0_54, 105, -1, -1, 0, 2, 1, 1, 0, 
"C - - 10 - oldpath C - - 10 - newpath", (char*) NULL
, funcptr._read, 0);
#ifndef vfork
   ...
   funcptr._write = 0;
#endif
   G__memfunc_setup("vfork", 552, G__posix__0_55, 105, -1, G__defined_typename("pid_t"), 0, 0, 1, 1, 0, "", (char*) NULL
, funcptr._read, 0);
#ifndef isDirectory
   ...
   funcptr._write = 0;
#endif
   G__memfunc_setup("isDirectory", 1169, G__posix__0_56, 105, -1, -1, 0, 1, 1, 1, 0, "U 'dirent' - 0 - pd", (char*) NULL
, funcptr._read, 0);
