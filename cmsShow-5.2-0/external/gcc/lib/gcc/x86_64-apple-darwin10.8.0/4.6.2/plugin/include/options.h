...
enum opt_code
{
  ...
  OPT_Wnonportable_cfstrings = 274,          /* -Wnonportable-cfstrings */
  ...
  OPT_Z = 383,                               /* -Z */
  OPT_Zall_load = 384,                       /* -Zall_load */
  OPT_Zallowable_client = 385,               /* -Zallowable_client */
  OPT_Zarch_errors_fatal = 386,              /* -Zarch_errors_fatal */
  OPT_Zbind_at_load = 387,                   /* -Zbind_at_load */
  OPT_Zbundle = 388,                         /* -Zbundle */
  OPT_Zbundle_loader = 389,                  /* -Zbundle_loader */
  OPT_Zdead_strip = 390,                     /* -Zdead_strip */
  OPT_Zdylib_file = 391,                     /* -Zdylib_file */
  OPT_Zdynamic = 392,                        /* -Zdynamic */
  OPT_Zdynamiclib = 393,                     /* -Zdynamiclib */
  OPT_Zexported_symbols_list = 394,          /* -Zexported_symbols_list */
  OPT_Zflat_namespace = 395,                 /* -Zflat_namespace */
  OPT_Zfn_seg_addr_table_filename = 396,     /* -Zfn_seg_addr_table_filename */
  OPT_Zforce_cpusubtype_ALL = 397,           /* -Zforce_cpusubtype_ALL */
  OPT_Zforce_flat_namespace = 398,           /* -Zforce_flat_namespace */
  OPT_Zimage_base = 399,                     /* -Zimage_base */
  OPT_Zinit = 400,                           /* -Zinit */
  OPT_Zinstall_name = 401,                   /* -Zinstall_name */
  OPT_Zmulti_module = 402,                   /* -Zmulti_module */
  OPT_Zmultiply_defined = 403,               /* -Zmultiply_defined */
  OPT_Zmultiplydefinedunused = 404,          /* -Zmultiplydefinedunused */
  OPT_Zno_dead_strip_inits_and_terms = 405,  /* -Zno_dead_strip_inits_and_terms */
  OPT_Zseg_addr_table = 406,                 /* -Zseg_addr_table */
  OPT_Zsegaddr = 407,                        /* -Zsegaddr */
  OPT_Zsegs_read_only_addr = 408,            /* -Zsegs_read_only_addr */
  OPT_Zsegs_read_write_addr = 409,           /* -Zsegs_read_write_addr */
  OPT_Zsingle_module = 410,                  /* -Zsingle_module */
  OPT_Zumbrella = 411,                       /* -Zumbrella */
  OPT_Zunexported_symbols_list = 412,        /* -Zunexported_symbols_list */
  OPT_Zweak_reference_mismatches = 413,      /* -Zweak_reference_mismatches */
  /* OPT_all_load = 414, */                  /* -all_load */
  /* OPT_allowable_client = 415, */          /* -allowable_client */
  OPT_ansi = 416,                            /* -ansi */
  OPT_arch = 417,                            /* -arch */
  /* OPT_arch_errors_fatal = 418, */         /* -arch_errors_fatal */
  OPT_aux_info = 419,                        /* -aux-info */
  /* OPT_aux_info_ = 420, */                 /* -aux-info= */
  OPT_auxbase = 421,                         /* -auxbase */
  OPT_auxbase_strip = 422,                   /* -auxbase-strip */
  /* OPT_bind_at_load = 423, */              /* -bind_at_load */
  /* OPT_bootclasspath = 424, */             /* -bootclasspath */
  /* OPT_bundle = 425, */                    /* -bundle */
  /* OPT_bundle_loader = 426, */             /* -bundle_loader */
  OPT_c = 427,                               /* -c */
  /* OPT_classpath = 428, */                 /* -classpath */
  OPT_client_name = 429,                     /* -client_name */
  OPT_compatibility_version = 430,           /* -compatibility_version */
  OPT_coverage = 431,                        /* -coverage */
  OPT_cpp = 432,                             /* -cpp */
  OPT_cpp_ = 433,                            /* -cpp= */
  OPT_current_version = 434,                 /* -current_version */
  OPT_d = 435,                               /* -d */
  /* OPT_dead_strip = 436, */                /* -dead_strip */
  /* OPT_dependency_file = 437, */           /* -dependency-file */
  OPT_dumpbase = 438,                        /* -dumpbase */
  OPT_dumpdir = 439,                         /* -dumpdir */
  OPT_dumpmachine = 440,                     /* -dumpmachine */
  OPT_dumpspecs = 441,                       /* -dumpspecs */
  OPT_dumpversion = 442,                     /* -dumpversion */
  /* OPT_dylib_file = 443, */                /* -dylib_file */
  OPT_dylinker = 444,                        /* -dylinker */
  OPT_dylinker_install_name = 445,           /* -dylinker_install_name */
  /* OPT_dynamic = 446, */                   /* -dynamic */
  /* OPT_dynamiclib = 447, */                /* -dynamiclib */
  OPT_e = 448,                               /* -e */
  /* OPT_encoding = 449, */                  /* -encoding */
  OPT_export_dynamic = 450,                  /* -export-dynamic */
  /* OPT_exported_symbols_list = 451, */     /* -exported_symbols_list */
  OPT_extdirs = 452,                         /* -extdirs */
  /* OPT_fCLASSPATH_ = 453, */               /* -fCLASSPATH= */
  OPT_fPIC = 454,                            /* -fPIC */
  OPT_fPIE = 455,                            /* -fPIE */
  OPT_fRTS_ = 456,                           /* -fRTS= */
  OPT_fabi_version_ = 457,                   /* -fabi-version= */
  OPT_faccess_control = 458,                 /* -faccess-control */
  OPT_falign_commons = 459,                  /* -falign-commons */
  OPT_falign_functions = 460,                /* -falign-functions */
  OPT_falign_functions_ = 461,               /* -falign-functions= */
  OPT_falign_jumps = 462,                    /* -falign-jumps */
  OPT_falign_jumps_ = 463,                   /* -falign-jumps= */
  OPT_falign_labels = 464,                   /* -falign-labels */
  OPT_falign_labels_ = 465,                  /* -falign-labels= */
  OPT_falign_loops = 466,                    /* -falign-loops */
  OPT_falign_loops_ = 467,                   /* -falign-loops= */
  OPT_fall_intrinsics = 468,                 /* -fall-intrinsics */
  /* OPT_fall_virtual = 469, */              /* -fall-virtual */
  OPT_fallow_leading_underscore = 470,       /* -fallow-leading-underscore */
  /* OPT_falt_external_templates = 471, */   /* -falt-external-templates */
  OPT_fapple_kext = 472,                     /* -fapple-kext */
  /* OPT_fargument_alias = 473, */           /* -fargument-alias */
  /* OPT_fargument_noalias = 474, */         /* -fargument-noalias */
  /* OPT_fargument_noalias_anything = 475, *//* -fargument-noalias-anything */
  /* OPT_fargument_noalias_global = 476, */  /* -fargument-noalias-global */
  OPT_fasm = 477,                            /* -fasm */
  OPT_fassert = 478,                         /* -fassert */
  OPT_fassociative_math = 479,               /* -fassociative-math */
  OPT_fassume_compiled = 480,                /* -fassume-compiled */
  OPT_fassume_compiled_ = 481,               /* -fassume-compiled= */
  OPT_fasynchronous_unwind_tables = 482,     /* -fasynchronous-unwind-tables */
  OPT_fauto_inc_dec = 483,                   /* -fauto-inc-dec */
  OPT_fautomatic = 484,                      /* -fautomatic */
  OPT_faux_classpath = 485,                  /* -faux-classpath */
  OPT_fbackslash = 486,                      /* -fbackslash */
  OPT_fbacktrace = 487,                      /* -fbacktrace */
  OPT_fblas_matmul_limit_ = 488,             /* -fblas-matmul-limit= */
  OPT_fbootclasspath_ = 489,                 /* -fbootclasspath= */
  OPT_fbootstrap_classes = 490,              /* -fbootstrap-classes */
  OPT_fbounds_check = 491,                   /* -fbounds-check */
  OPT_fbranch_count_reg = 492,               /* -fbranch-count-reg */
  OPT_fbranch_probabilities = 493,           /* -fbranch-probabilities */
  OPT_fbranch_target_load_optimize = 494,    /* -fbranch-target-load-optimize */
  OPT_fbranch_target_load_optimize2 = 495,   /* -fbranch-target-load-optimize2 */
  OPT_fbtr_bb_exclusive = 496,               /* -fbtr-bb-exclusive */
  OPT_fbuiltin = 497,                        /* -fbuiltin */
  OPT_fbuiltin_ = 498,                       /* -fbuiltin- */
  OPT_fcall_saved_ = 499,                    /* -fcall-saved- */
  OPT_fcall_used_ = 500,                     /* -fcall-used- */
  OPT_fcaller_saves = 501,                   /* -fcaller-saves */
  OPT_fcheck_array_temporaries = 502,        /* -fcheck-array-temporaries */
  OPT_fcheck_data_deps = 503,                /* -fcheck-data-deps */
  OPT_fcheck_new = 504,                      /* -fcheck-new */
  OPT_fcheck_references = 505,               /* -fcheck-references */
  OPT_fcheck_ = 506,                         /* -fcheck= */
  OPT_fclasspath_ = 507,                     /* -fclasspath= */
  OPT_fcoarray_ = 508,                       /* -fcoarray= */
  OPT_fcombine_stack_adjustments = 509,      /* -fcombine-stack-adjustments */
  OPT_fcommon = 510,                         /* -fcommon */
  OPT_fcompare_debug = 511,                  /* -fcompare-debug */
  OPT_fcompare_debug_second = 512,           /* -fcompare-debug-second */
  OPT_fcompare_debug_ = 513,                 /* -fcompare-debug= */
  OPT_fcompare_elim = 514,                   /* -fcompare-elim */
  OPT_fcompile_resource_ = 515,              /* -fcompile-resource= */
  OPT_fcond_mismatch = 516,                  /* -fcond-mismatch */
  OPT_fconserve_space = 517,                 /* -fconserve-space */
  OPT_fconserve_stack = 518,                 /* -fconserve-stack */
  OPT_fconstant_string_class_ = 519,         /* -fconstant-string-class= */
  OPT_fconstexpr_depth_ = 520,               /* -fconstexpr-depth= */
  OPT_fconvert_big_endian = 521,             /* -fconvert=big-endian */
  OPT_fconvert_little_endian = 522,          /* -fconvert=little-endian */
  OPT_fconvert_native = 523,                 /* -fconvert=native */
  OPT_fconvert_swap = 524,                   /* -fconvert=swap */
  OPT_fcprop_registers = 525,                /* -fcprop-registers */
  OPT_fcray_pointer = 526,                   /* -fcray-pointer */
  OPT_fcrossjumping = 527,                   /* -fcrossjumping */
  OPT_fcse_follow_jumps = 528,               /* -fcse-follow-jumps */
  /* OPT_fcse_skip_blocks = 529, */          /* -fcse-skip-blocks */
  OPT_fcx_fortran_rules = 530,               /* -fcx-fortran-rules */
  OPT_fcx_limited_range = 531,               /* -fcx-limited-range */
  OPT_fd_lines_as_code = 532,                /* -fd-lines-as-code */
  OPT_fd_lines_as_comments = 533,            /* -fd-lines-as-comments */
  OPT_fdata_sections = 534,                  /* -fdata-sections */
  OPT_fdbg_cnt_list = 535,                   /* -fdbg-cnt-list */
  OPT_fdbg_cnt_ = 536,                       /* -fdbg-cnt= */
  OPT_fdce = 537,                            /* -fdce */
  OPT_fdebug_prefix_map_ = 538,              /* -fdebug-prefix-map= */
  ...
  OPT_fdelete_null_pointer_checks = 546,     /* -fdelete-null-pointer-checks */
  OPT_fdevirtualize = 547,                   /* -fdevirtualize */
  ...
  OPT_fdump_core = 557,                      /* -fdump-core */
  OPT_fdump_final_insns = 558,               /* -fdump-final-insns */
  OPT_fdump_final_insns_ = 559,              /* -fdump-final-insns= */
  OPT_fdump_fortran_optimized = 560,         /* -fdump-fortran-optimized */
  OPT_fdump_fortran_original = 561,          /* -fdump-fortran-original */
  OPT_fdump_go_spec_ = 562,                  /* -fdump-go-spec= */
  OPT_fdump_noaddr = 563,                    /* -fdump-noaddr */
  OPT_fdump_parse_tree = 564,                /* -fdump-parse-tree */
  OPT_fdump_unnumbered = 565,                /* -fdump-unnumbered */
  OPT_fdump_unnumbered_links = 566,          /* -fdump-unnumbered-links */
  OPT_fdwarf2_cfi_asm = 567,                 /* -fdwarf2-cfi-asm */
  OPT_fearly_inlining = 568,                 /* -fearly-inlining */
  OPT_felide_constructors = 569,             /* -felide-constructors */
  OPT_feliminate_dwarf2_dups = 570,          /* -feliminate-dwarf2-dups */
  OPT_feliminate_unused_debug_symbols = 571, /* -feliminate-unused-debug-symbols */
  OPT_feliminate_unused_debug_types = 572,   /* -feliminate-unused-debug-types */
  OPT_femit_class_debug_always = 573,        /* -femit-class-debug-always */
  OPT_femit_class_file = 574,                /* -femit-class-file */
  OPT_femit_class_files = 575,               /* -femit-class-files */
  OPT_femit_struct_debug_baseonly = 576,     /* -femit-struct-debug-baseonly */
  OPT_femit_struct_debug_detailed_ = 577,    /* -femit-struct-debug-detailed= */
  OPT_femit_struct_debug_reduced = 578,      /* -femit-struct-debug-reduced */
  OPT_fenable_assertions = 579,              /* -fenable-assertions */
  OPT_fenable_assertions_ = 580,             /* -fenable-assertions= */
  OPT_fenable_icf_debug = 581,               /* -fenable-icf-debug */
  OPT_fencoding_ = 582,                      /* -fencoding= */
  OPT_fenforce_eh_specs = 583,               /* -fenforce-eh-specs */
  /* OPT_fenum_int_equiv = 584, */           /* -fenum-int-equiv */
  OPT_fexceptions = 585,                     /* -fexceptions */
  OPT_fexcess_precision_ = 586,              /* -fexcess-precision= */
  OPT_fexec_charset_ = 587,                  /* -fexec-charset= */
  OPT_fexpensive_optimizations = 588,        /* -fexpensive-optimizations */
  ...
  OPT_fgo_prefix_ = 624,                     /* -fgo-prefix= */
  ...
  OPT_findirect_virtual_calls = 647,         /* -findirect-virtual-calls */
  OPT_finhibit_size_directive = 648,         /* -finhibit-size-directive */
  OPT_finit_character_ = 649,                /* -finit-character= */
  OPT_finit_integer_ = 650,                  /* -finit-integer= */
  OPT_finit_local_zero = 651,                /* -finit-local-zero */
  OPT_finit_logical_ = 652,                  /* -finit-logical= */
  OPT_finit_real_ = 653,                     /* -finit-real= */
  OPT_finline = 654,                         /* -finline */
  ...
  OPT_fira_loop_pressure = 675,              /* -fira-loop-pressure */
  OPT_fira_region_ = 676,                    /* -fira-region= */
  OPT_fira_share_save_slots = 677,           /* -fira-share-save-slots */
  OPT_fira_share_spill_slots = 678,          /* -fira-share-spill-slots */
  OPT_fira_verbose_ = 679,                   /* -fira-verbose= */
  OPT_fivopts = 680,                         /* -fivopts */
  OPT_fjni = 681,                            /* -fjni */
  OPT_fjump_tables = 682,                    /* -fjump-tables */
  OPT_fkeep_inline_dllexport = 683,          /* -fkeep-inline-dllexport */
  OPT_fkeep_inline_functions = 684,          /* -fkeep-inline-functions */
  OPT_fkeep_static_consts = 685,             /* -fkeep-static-consts */
  /* OPT_flabels_ok = 686, */                /* -flabels-ok */
  /* OPT_flat_namespace = 687, */            /* -flat_namespace */
  ...
  /* OPT_floop_optimize = 693, */            /* -floop-optimize */
  OPT_floop_parallelize_all = 694,           /* -floop-parallelize-all */
  OPT_floop_strip_mine = 695,                /* -floop-strip-mine */
  OPT_flto = 696,                            /* -flto */
  OPT_flto_compression_level_ = 697,         /* -flto-compression-level= */
  OPT_flto_partition_1to1 = 698,             /* -flto-partition=1to1 */
  OPT_flto_partition_balanced = 699,         /* -flto-partition=balanced */
  OPT_flto_partition_none = 700,             /* -flto-partition=none */
  OPT_flto_report = 701,                     /* -flto-report */
  OPT_flto_ = 702,                           /* -flto= */
  OPT_fltrans = 703,                         /* -fltrans */
  OPT_fltrans_output_list_ = 704,            /* -fltrans-output-list= */
  OPT_fmain_ = 705,                          /* -fmain= */
  OPT_fmath_errno = 706,                     /* -fmath-errno */
  OPT_fmax_array_constructor_ = 707,         /* -fmax-array-constructor= */
  OPT_fmax_errors_ = 708,                    /* -fmax-errors= */
  OPT_fmax_identifier_length_ = 709,         /* -fmax-identifier-length= */
  OPT_fmax_stack_var_size_ = 710,            /* -fmax-stack-var-size= */
  OPT_fmax_subrecord_length_ = 711,          /* -fmax-subrecord-length= */
  OPT_fmem_report = 712,                     /* -fmem-report */
  OPT_fmerge_all_constants = 713,            /* -fmerge-all-constants */
  OPT_fmerge_constants = 714,                /* -fmerge-constants */
  OPT_fmerge_debug_strings = 715,            /* -fmerge-debug-strings */
  OPT_fmessage_length_ = 716,                /* -fmessage-length= */
  OPT_fmodule_private = 717,                 /* -fmodule-private */
  OPT_fmodulo_sched = 718,                   /* -fmodulo-sched */
  OPT_fmodulo_sched_allow_regmoves = 719,    /* -fmodulo-sched-allow-regmoves */
  OPT_fmove_loop_invariants = 720,           /* -fmove-loop-invariants */
  OPT_fms_extensions = 721,                  /* -fms-extensions */
  OPT_fmudflap = 722,                        /* -fmudflap */
  OPT_fmudflapir = 723,                      /* -fmudflapir */
  OPT_fmudflapth = 724,                      /* -fmudflapth */
  /* OPT_fname_mangling_version_ = 725, */   /* -fname-mangling-version- */
  /* OPT_fnew_abi = 726, */                  /* -fnew-abi */
  OPT_fnext_runtime = 727,                   /* -fnext-runtime */
  OPT_fnil_receivers = 728,                  /* -fnil-receivers */
  OPT_fnon_call_exceptions = 729,            /* -fnon-call-exceptions */
  OPT_fnonansi_builtins = 730,               /* -fnonansi-builtins */
  /* OPT_fnonnull_objects = 731, */          /* -fnonnull-objects */
  OPT_fnothrow_opt = 732,                    /* -fnothrow-opt */
  OPT_fobjc_abi_version_ = 733,              /* -fobjc-abi-version= */
  OPT_fobjc_call_cxx_cdtors = 734,           /* -fobjc-call-cxx-cdtors */
  OPT_fobjc_direct_dispatch = 735,           /* -fobjc-direct-dispatch */
  OPT_fobjc_exceptions = 736,                /* -fobjc-exceptions */
  OPT_fobjc_gc = 737,                        /* -fobjc-gc */
  OPT_fobjc_nilcheck = 738,                  /* -fobjc-nilcheck */
  OPT_fobjc_sjlj_exceptions = 739,           /* -fobjc-sjlj-exceptions */
  OPT_fobjc_std_objc1 = 740,                 /* -fobjc-std=objc1 */
  OPT_fomit_frame_pointer = 741,             /* -fomit-frame-pointer */
  OPT_fopenmp = 742,                         /* -fopenmp */
  OPT_foperator_names = 743,                 /* -foperator-names */
  OPT_foptimize_register_move = 744,         /* -foptimize-register-move */
  OPT_foptimize_sibling_calls = 745,         /* -foptimize-sibling-calls */
  OPT_foptimize_static_class_initialization = 746,/* -foptimize-static-class-initialization */
  /* OPT_foptional_diags = 747, */           /* -foptional-diags */
  /* OPT_force_cpusubtype_ALL = 748, */      /* -force_cpusubtype_ALL */
  /* OPT_force_flat_namespace = 749, */      /* -force_flat_namespace */
  OPT_foutput_class_dir_ = 750,              /* -foutput-class-dir= */
  OPT_fpack_derived = 751,                   /* -fpack-derived */
  OPT_fpack_struct = 752,                    /* -fpack-struct */
  OPT_fpack_struct_ = 753,                   /* -fpack-struct= */
  OPT_fpartial_inlining = 754,               /* -fpartial-inlining */
  OPT_fpcc_struct_return = 755,              /* -fpcc-struct-return */
  OPT_fpch_deps = 756,                       /* -fpch-deps */
  OPT_fpch_preprocess = 757,                 /* -fpch-preprocess */
  OPT_fpeel_loops = 758,                     /* -fpeel-loops */
  OPT_fpeephole = 759,                       /* -fpeephole */
  OPT_fpeephole2 = 760,                      /* -fpeephole2 */
  OPT_fpermissive = 761,                     /* -fpermissive */
  OPT_fpic = 762,                            /* -fpic */
  OPT_fpie = 763,                            /* -fpie */
  OPT_fplan9_extensions = 764,               /* -fplan9-extensions */
  OPT_fplugin_arg_ = 765,                    /* -fplugin-arg- */
  OPT_fplugin_ = 766,                        /* -fplugin= */
  OPT_fpost_ipa_mem_report = 767,            /* -fpost-ipa-mem-report */
  OPT_fpre_ipa_mem_report = 768,             /* -fpre-ipa-mem-report */
  OPT_fpredictive_commoning = 769,           /* -fpredictive-commoning */
  OPT_fprefetch_loop_arrays = 770,           /* -fprefetch-loop-arrays */
  OPT_fpreprocessed = 771,                   /* -fpreprocessed */
  OPT_fpretty_templates = 772,               /* -fpretty-templates */
  OPT_fprofile = 773,                        /* -fprofile */
  OPT_fprofile_arcs = 774,                   /* -fprofile-arcs */
  OPT_fprofile_correction = 775,             /* -fprofile-correction */
  OPT_fprofile_dir_ = 776,                   /* -fprofile-dir= */
  OPT_fprofile_generate = 777,               /* -fprofile-generate */
  OPT_fprofile_generate_ = 778,              /* -fprofile-generate= */
  OPT_fprofile_use = 779,                    /* -fprofile-use */
  OPT_fprofile_use_ = 780,                   /* -fprofile-use= */
  OPT_fprofile_values = 781,                 /* -fprofile-values */
  OPT_fprotect_parens = 782,                 /* -fprotect-parens */
  OPT_framework = 783,                       /* -framework */
  OPT_frandom_seed = 784,                    /* -frandom-seed */
  OPT_frandom_seed_ = 785,                   /* -frandom-seed= */
  OPT_frange_check = 786,                    /* -frange-check */
  OPT_frealloc_lhs = 787,                    /* -frealloc-lhs */
  OPT_freciprocal_math = 788,                /* -freciprocal-math */
  OPT_frecord_gcc_switches = 789,            /* -frecord-gcc-switches */
  OPT_frecord_marker_4 = 790,                /* -frecord-marker=4 */
  OPT_frecord_marker_8 = 791,                /* -frecord-marker=8 */
  OPT_frecursive = 792,                      /* -frecursive */
  OPT_freduced_reflection = 793,             /* -freduced-reflection */
  OPT_freg_struct_return = 794,              /* -freg-struct-return */
  OPT_fregmove = 795,                        /* -fregmove */
  OPT_frename_registers = 796,               /* -frename-registers */
  OPT_freorder_blocks = 797,                 /* -freorder-blocks */
  OPT_freorder_blocks_and_partition = 798,   /* -freorder-blocks-and-partition */
  OPT_freorder_functions = 799,              /* -freorder-functions */
  OPT_frepack_arrays = 800,                  /* -frepack-arrays */
  OPT_freplace_objc_classes = 801,           /* -freplace-objc-classes */
  OPT_frepo = 802,                           /* -frepo */
  OPT_frequire_return_statement = 803,       /* -frequire-return-statement */
  OPT_frerun_cse_after_loop = 804,           /* -frerun-cse-after-loop */
  /* OPT_frerun_loop_opt = 805, */           /* -frerun-loop-opt */
  OPT_freschedule_modulo_scheduled_loops = 806,/* -freschedule-modulo-scheduled-loops */
  OPT_fresolution_ = 807,                    /* -fresolution= */
  OPT_frounding_math = 808,                  /* -frounding-math */
  OPT_frtti = 809,                           /* -frtti */
  OPT_fsaw_java_file = 810,                  /* -fsaw-java-file */
  OPT_fsched_critical_path_heuristic = 811,  /* -fsched-critical-path-heuristic */
  OPT_fsched_dep_count_heuristic = 812,      /* -fsched-dep-count-heuristic */
  OPT_fsched_group_heuristic = 813,          /* -fsched-group-heuristic */
  OPT_fsched_interblock = 814,               /* -fsched-interblock */
  OPT_fsched_last_insn_heuristic = 815,      /* -fsched-last-insn-heuristic */
  OPT_fsched_pressure = 816,                 /* -fsched-pressure */
  OPT_fsched_rank_heuristic = 817,           /* -fsched-rank-heuristic */
  OPT_fsched_spec = 818,                     /* -fsched-spec */
  OPT_fsched_spec_insn_heuristic = 819,      /* -fsched-spec-insn-heuristic */
  OPT_fsched_spec_load = 820,                /* -fsched-spec-load */
  OPT_fsched_spec_load_dangerous = 821,      /* -fsched-spec-load-dangerous */
  OPT_fsched_stalled_insns = 822,            /* -fsched-stalled-insns */
  OPT_fsched_stalled_insns_dep = 823,        /* -fsched-stalled-insns-dep */
  OPT_fsched_stalled_insns_dep_ = 824,       /* -fsched-stalled-insns-dep= */
  OPT_fsched_stalled_insns_ = 825,           /* -fsched-stalled-insns= */
  OPT_fsched_verbose_ = 826,                 /* -fsched-verbose= */
  OPT_fsched2_use_superblocks = 827,         /* -fsched2-use-superblocks */
  /* OPT_fsched2_use_traces = 828, */        /* -fsched2-use-traces */
  ...
  OPT_fshort_double = 839,                   /* -fshort-double */
  OPT_fshort_enums = 840,                    /* -fshort-enums */
  OPT_fshort_wchar = 841,                    /* -fshort-wchar */
  OPT_fshow_column = 842,                    /* -fshow-column */
  OPT_fsign_zero = 843,                      /* -fsign-zero */
  OPT_fsignaling_nans = 844,                 /* -fsignaling-nans */
  OPT_fsigned_bitfields = 845,               /* -fsigned-bitfields */
  OPT_fsigned_char = 846,                    /* -fsigned-char */
  OPT_fsigned_zeros = 847,                   /* -fsigned-zeros */
  OPT_fsingle_precision_constant = 848,      /* -fsingle-precision-constant */
  OPT_fsource_filename_ = 849,               /* -fsource-filename= */
  OPT_fsource_ = 850,                        /* -fsource= */
  OPT_fsplit_ivs_in_unroller = 851,          /* -fsplit-ivs-in-unroller */
  OPT_fsplit_stack = 852,                    /* -fsplit-stack */
  OPT_fsplit_wide_types = 853,               /* -fsplit-wide-types */
  /* OPT_fsquangle = 854, */                 /* -fsquangle */
  /* OPT_fstack_check = 855, */              /* -fstack-check */
  OPT_fstack_check_ = 856,                   /* -fstack-check= */
  OPT_fstack_limit = 857,                    /* -fstack-limit */
  OPT_fstack_limit_register_ = 858,          /* -fstack-limit-register= */
  OPT_fstack_limit_symbol_ = 859,            /* -fstack-limit-symbol= */
  OPT_fstack_protector = 860,                /* -fstack-protector */
  OPT_fstack_protector_all = 861,            /* -fstack-protector-all */
  OPT_fstack_usage = 862,                    /* -fstack-usage */
  OPT_fstats = 863,                          /* -fstats */
  OPT_fstore_check = 864,                    /* -fstore-check */
  /* OPT_fstrength_reduce = 865, */          /* -fstrength-reduce */
  OPT_fstrict_aliasing = 866,                /* -fstrict-aliasing */
  OPT_fstrict_enums = 867,                   /* -fstrict-enums */
  OPT_fstrict_overflow = 868,                /* -fstrict-overflow */
  /* OPT_fstrict_prototype = 869, */         /* -fstrict-prototype */
  OPT_fstrict_volatile_bitfields = 870,      /* -fstrict-volatile-bitfields */
  OPT_fsyntax_only = 871,                    /* -fsyntax-only */
  OPT_ftabstop_ = 872,                       /* -ftabstop= */
  /* OPT_ftarget_help = 873, */              /* -ftarget-help */
  OPT_ftarget_ = 874,                        /* -ftarget= */
  /* OPT_ftemplate_depth_ = 875, */          /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 876,                /* -ftemplate-depth= */
  OPT_fterminated_vtables = 877,             /* -fterminated-vtables */
  OPT_ftest_coverage = 878,                  /* -ftest-coverage */
  /* OPT_fthis_is_variable = 879, */         /* -fthis-is-variable */
  OPT_fthread_jumps = 880,                   /* -fthread-jumps */
  OPT_fthreadsafe_statics = 881,             /* -fthreadsafe-statics */
  OPT_ftime_report = 882,                    /* -ftime-report */
  OPT_ftls_model_ = 883,                     /* -ftls-model= */
  OPT_ftoplevel_reorder = 884,               /* -ftoplevel-reorder */
  OPT_ftracer = 885,                         /* -ftracer */
  OPT_ftrapping_math = 886,                  /* -ftrapping-math */
  OPT_ftrapv = 887,                          /* -ftrapv */
  OPT_ftree_bit_ccp = 888,                   /* -ftree-bit-ccp */
  OPT_ftree_builtin_call_dce = 889,          /* -ftree-builtin-call-dce */
  OPT_ftree_ccp = 890,                       /* -ftree-ccp */
  OPT_ftree_ch = 891,                        /* -ftree-ch */
  OPT_ftree_copy_prop = 892,                 /* -ftree-copy-prop */
  OPT_ftree_copyrename = 893,                /* -ftree-copyrename */
  OPT_ftree_cselim = 894,                    /* -ftree-cselim */
  OPT_ftree_dce = 895,                       /* -ftree-dce */
  OPT_ftree_dominator_opts = 896,            /* -ftree-dominator-opts */
  OPT_ftree_dse = 897,                       /* -ftree-dse */
  OPT_ftree_forwprop = 898,                  /* -ftree-forwprop */
  OPT_ftree_fre = 899,                       /* -ftree-fre */
  OPT_ftree_loop_distribute_patterns = 900,  /* -ftree-loop-distribute-patterns */
  OPT_ftree_loop_distribution = 901,         /* -ftree-loop-distribution */
  OPT_ftree_loop_if_convert = 902,           /* -ftree-loop-if-convert */
  OPT_ftree_loop_if_convert_stores = 903,    /* -ftree-loop-if-convert-stores */
  OPT_ftree_loop_im = 904,                   /* -ftree-loop-im */
  OPT_ftree_loop_ivcanon = 905,              /* -ftree-loop-ivcanon */
  /* OPT_ftree_loop_linear = 906, */         /* -ftree-loop-linear */
  OPT_ftree_loop_optimize = 907,             /* -ftree-loop-optimize */
  OPT_ftree_lrs = 908,                       /* -ftree-lrs */
  OPT_ftree_parallelize_loops_ = 909,        /* -ftree-parallelize-loops= */
  OPT_ftree_phiprop = 910,                   /* -ftree-phiprop */
  OPT_ftree_pre = 911,                       /* -ftree-pre */
  OPT_ftree_pta = 912,                       /* -ftree-pta */
  OPT_ftree_reassoc = 913,                   /* -ftree-reassoc */
  /* OPT_ftree_salias = 914, */              /* -ftree-salias */
  OPT_ftree_scev_cprop = 915,                /* -ftree-scev-cprop */
  OPT_ftree_sink = 916,                      /* -ftree-sink */
  OPT_ftree_slp_vectorize = 917,             /* -ftree-slp-vectorize */
  OPT_ftree_sra = 918,                       /* -ftree-sra */
  /* OPT_ftree_store_ccp = 919, */           /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 920, */     /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 921,         /* -ftree-switch-conversion */
  OPT_ftree_ter = 922,                       /* -ftree-ter */
  OPT_ftree_vect_loop_version = 923,         /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 924,                 /* -ftree-vectorize */
  OPT_ftree_vectorizer_verbose_ = 925,       /* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 926,                       /* -ftree-vrp */
  OPT_funderscoring = 927,                   /* -funderscoring */
  OPT_funit_at_a_time = 928,                 /* -funit-at-a-time */
  OPT_funroll_all_loops = 929,               /* -funroll-all-loops */
  OPT_funroll_loops = 930,                   /* -funroll-loops */
  OPT_funsafe_loop_optimizations = 931,      /* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 932,      /* -funsafe-math-optimizations */
  OPT_funsigned_bitfields = 933,             /* -funsigned-bitfields */
  OPT_funsigned_char = 934,                  /* -funsigned-char */
  OPT_funswitch_loops = 935,                 /* -funswitch-loops */
  OPT_funwind_tables = 936,                  /* -funwind-tables */
  OPT_fuse_atomic_builtins = 937,            /* -fuse-atomic-builtins */
  OPT_fuse_boehm_gc = 938,                   /* -fuse-boehm-gc */
  OPT_fuse_cxa_atexit = 939,                 /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 940,      /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_divide_subroutine = 941,          /* -fuse-divide-subroutine */
  OPT_fuse_linker_plugin = 942,              /* -fuse-linker-plugin */
  OPT_fvar_tracking = 943,                   /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 944,       /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 945,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 946,            /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 947, /* -fvariable-expansion-in-unroller */
  OPT_fvect_cost_model = 948,                /* -fvect-cost-model */
  OPT_fverbose_asm = 949,                    /* -fverbose-asm */
  /* OPT_fversion = 950, */                  /* -fversion */
  OPT_fvisibility_inlines_hidden = 951,      /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 952,           /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 953,                    /* -fvisibility= */
  OPT_fvpt = 954,                            /* -fvpt */
  /* OPT_fvtable_gc = 955, */                /* -fvtable-gc */
  /* OPT_fvtable_thunks = 956, */            /* -fvtable-thunks */
  OPT_fweak = 957,                           /* -fweak */
  OPT_fweb = 958,                            /* -fweb */
  OPT_fwhole_file = 959,                     /* -fwhole-file */
  OPT_fwhole_program = 960,                  /* -fwhole-program */
  OPT_fwide_exec_charset_ = 961,             /* -fwide-exec-charset= */
  OPT_fworking_directory = 962,              /* -fworking-directory */
  OPT_fwpa = 963,                            /* -fwpa */
  OPT_fwrapv = 964,                          /* -fwrapv */
  /* OPT_fxref = 965, */                     /* -fxref */
  OPT_fzee = 966,                            /* -fzee */
  OPT_fzero_initialized_in_bss = 967,        /* -fzero-initialized-in-bss */
  OPT_fzero_link = 968,                      /* -fzero-link */
  OPT_g = 969,                               /* -g */
  OPT_gant = 970,                            /* -gant */
  OPT_gcoff = 971,                           /* -gcoff */
  OPT_gdwarf_ = 972,                         /* -gdwarf- */
  OPT_gen_decls = 973,                       /* -gen-decls */
  OPT_gfull = 974,                           /* -gfull */
  OPT_ggdb = 975,                            /* -ggdb */
  OPT_gnat = 976,                            /* -gnat */
  OPT_gnatO = 977,                           /* -gnatO */
  OPT_gno_strict_dwarf = 978,                /* -gno-strict-dwarf */
  OPT_gstabs = 979,                          /* -gstabs */
  OPT_gstabs_ = 980,                         /* -gstabs+ */
  OPT_gstrict_dwarf = 981,                   /* -gstrict-dwarf */
  OPT_gtoggle = 982,                         /* -gtoggle */
  OPT_gused = 983,                           /* -gused */
  OPT_gvms = 984,                            /* -gvms */
  OPT_gxcoff = 985,                          /* -gxcoff */
  OPT_gxcoff_ = 986,                         /* -gxcoff+ */
  OPT_h = 987,                               /* -h */
  OPT_headerpad_max_install_names = 988,     /* -headerpad_max_install_names */
  OPT_idirafter = 989,                       /* -idirafter */
  OPT_iframework = 990,                      /* -iframework */
  OPT_imacros = 991,                         /* -imacros */
  /* OPT_image_base = 992, */                /* -image_base */
  OPT_imultilib = 993,                       /* -imultilib */
  OPT_include = 994,                         /* -include */
  /* OPT_init = 995, */                      /* -init */
  /* OPT_install_name = 996, */              /* -install_name */
  OPT_iplugindir_ = 997,                     /* -iplugindir= */
  OPT_iprefix = 998,                         /* -iprefix */
  OPT_iquote = 999,                          /* -iquote */
  OPT_isysroot = 1000,                       /* -isysroot */
  OPT_isystem = 1001,                        /* -isystem */
  OPT_iwithprefix = 1002,                    /* -iwithprefix */
  OPT_iwithprefixbefore = 1003,              /* -iwithprefixbefore */
  OPT_k8 = 1004,                             /* -k8 */
  OPT_keep_private_externs = 1005,           /* -keep_private_externs */
  OPT_l = 1006,                              /* -l */
  OPT_lang_asm = 1007,                       /* -lang-asm */
  OPT_m128bit_long_double = 1008,            /* -m128bit-long-double */
  OPT_m32 = 1009,                            /* -m32 */
  OPT_m3dnow = 1010,                         /* -m3dnow */
  OPT_m3dnowa = 1011,                        /* -m3dnowa */
  OPT_m64 = 1012,                            /* -m64 */
  OPT_m80387 = 1013,                         /* -m80387 */
  OPT_m8bit_idiv = 1014,                     /* -m8bit-idiv */
  OPT_m96bit_long_double = 1015,             /* -m96bit-long-double */
  OPT_mabi_ = 1016,                          /* -mabi= */
  OPT_mabm = 1017,                           /* -mabm */
  OPT_maccumulate_outgoing_args = 1018,      /* -maccumulate-outgoing-args */
  OPT_maes = 1019,                           /* -maes */
  OPT_malign_double = 1020,                  /* -malign-double */
  OPT_malign_functions_ = 1021,              /* -malign-functions= */
  OPT_malign_jumps_ = 1022,                  /* -malign-jumps= */
  OPT_malign_loops_ = 1023,                  /* -malign-loops= */
  OPT_malign_stringops = 1024,               /* -malign-stringops */
  OPT_march_ = 1025,                         /* -march= */
  OPT_masm_ = 1026,                          /* -masm= */
  OPT_matt_stubs = 1027,                     /* -matt-stubs */
  OPT_mavx = 1028,                           /* -mavx */
  OPT_mavx256_split_unaligned_load = 1029,   /* -mavx256-split-unaligned-load */
  OPT_mavx256_split_unaligned_store = 1030,  /* -mavx256-split-unaligned-store */
  OPT_mbmi = 1031,                           /* -mbmi */
  OPT_mbranch_cost_ = 1032,                  /* -mbranch-cost= */
  OPT_mcld = 1033,                           /* -mcld */
  OPT_mcmodel_ = 1034,                       /* -mcmodel= */
  OPT_mconstant_cfstrings = 1035,            /* -mconstant-cfstrings */
  /* OPT_mcpu_ = 1036, */                    /* -mcpu= */
  OPT_mcrc32 = 1037,                         /* -mcrc32 */
  OPT_mcx16 = 1038,                          /* -mcx16 */
  OPT_mdispatch_scheduler = 1039,            /* -mdispatch-scheduler */
  OPT_mdynamic_no_pic = 1040,                /* -mdynamic-no-pic */
  OPT_mf16c = 1041,                          /* -mf16c */
  OPT_mfancy_math_387 = 1042,                /* -mfancy-math-387 */
  OPT_mfentry = 1043,                        /* -mfentry */
  OPT_mfix_and_continue = 1044,              /* -mfix-and-continue */
  OPT_mfma = 1045,                           /* -mfma */
  OPT_mfma4 = 1046,                          /* -mfma4 */
  OPT_mforce_drap = 1047,                    /* -mforce-drap */
  OPT_mfp_ret_in_387 = 1048,                 /* -mfp-ret-in-387 */
  OPT_mfpmath_ = 1049,                       /* -mfpmath= */
  OPT_mfsgsbase = 1050,                      /* -mfsgsbase */
  /* OPT_mfused_madd = 1051, */              /* -mfused-madd */
  OPT_mhard_float = 1052,                    /* -mhard-float */
  OPT_mieee_fp = 1053,                       /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 1054,      /* -mincoming-stack-boundary= */
  OPT_minline_all_stringops = 1055,          /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 1056,  /* -minline-stringops-dynamically */
  /* OPT_mintel_syntax = 1057, */            /* -mintel-syntax */
  OPT_mkernel = 1058,                        /* -mkernel */
  OPT_mlarge_data_threshold_ = 1059,         /* -mlarge-data-threshold= */
  OPT_mlwp = 1060,                           /* -mlwp */
  OPT_mmacosx_version_min_ = 1061,           /* -mmacosx-version-min= */
  OPT_mmmx = 1062,                           /* -mmmx */
  OPT_mmovbe = 1063,                         /* -mmovbe */
  OPT_mms_bitfields = 1064,                  /* -mms-bitfields */
  OPT_mno_align_stringops = 1065,            /* -mno-align-stringops */
  OPT_mno_fancy_math_387 = 1066,             /* -mno-fancy-math-387 */
  OPT_mno_push_args = 1067,                  /* -mno-push-args */
  OPT_mno_red_zone = 1068,                   /* -mno-red-zone */
  OPT_mno_sse4 = 1069,                       /* -mno-sse4 */
  OPT_momit_leaf_frame_pointer = 1070,       /* -momit-leaf-frame-pointer */
  OPT_mone_byte_bool = 1071,                 /* -mone-byte-bool */
  OPT_mpc = 1072,                            /* -mpc */
  OPT_mpclmul = 1073,                        /* -mpclmul */
  OPT_mpopcnt = 1074,                        /* -mpopcnt */
  OPT_mprefer_avx128 = 1075,                 /* -mprefer-avx128 */
  OPT_mpreferred_stack_boundary_ = 1076,     /* -mpreferred-stack-boundary= */
  OPT_mpush_args = 1077,                     /* -mpush-args */
  OPT_mrdrnd = 1078,                         /* -mrdrnd */
  OPT_mrecip = 1079,                         /* -mrecip */
  OPT_mred_zone = 1080,                      /* -mred-zone */
  OPT_mregparm_ = 1081,                      /* -mregparm= */
  OPT_mrtd = 1082,                           /* -mrtd */
  OPT_msahf = 1083,                          /* -msahf */
  OPT_msoft_float = 1084,                    /* -msoft-float */
  OPT_msse = 1085,                           /* -msse */
  OPT_msse2 = 1086,                          /* -msse2 */
  OPT_msse2avx = 1087,                       /* -msse2avx */
  OPT_msse3 = 1088,                          /* -msse3 */
  OPT_msse4 = 1089,                          /* -msse4 */
  OPT_msse4_1 = 1090,                        /* -msse4.1 */
  OPT_msse4_2 = 1091,                        /* -msse4.2 */
  OPT_msse4a = 1092,                         /* -msse4a */
  /* OPT_msse5 = 1093, */                    /* -msse5 */
  OPT_msseregparm = 1094,                    /* -msseregparm */
  OPT_mssse3 = 1095,                         /* -mssse3 */
  OPT_mstack_arg_probe = 1096,               /* -mstack-arg-probe */
  OPT_mstackrealign = 1097,                  /* -mstackrealign */
  OPT_mstringop_strategy_ = 1098,            /* -mstringop-strategy= */
  OPT_mtbm = 1099,                           /* -mtbm */
  OPT_mtls_dialect_ = 1100,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 1101,           /* -mtls-direct-seg-refs */
  OPT_mtune_ = 1102,                         /* -mtune= */
  /* OPT_multi_module = 1103, */             /* -multi_module */
  /* OPT_multiply_defined = 1104, */         /* -multiply_defined */
  /* OPT_multiply_defined_unused = 1105, */  /* -multiply_defined_unused */
  OPT_mveclibabi_ = 1106,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 1107,              /* -mvect8-ret-in-mem */
  OPT_mvzeroupper = 1108,                    /* -mvzeroupper */
  OPT_mxop = 1109,                           /* -mxop */
  OPT_n = 1110,                              /* -n */
  OPT_no_canonical_prefixes = 1111,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1112,              /* -no-integrated-cpp */
  /* OPT_no_dead_strip_inits_and_terms = 1113, *//* -no_dead_strip_inits_and_terms */
  OPT_nocpp = 1114,                          /* -nocpp */
  OPT_nodefaultlibs = 1115,                  /* -nodefaultlibs */
  OPT_nofixprebinding = 1116,                /* -nofixprebinding */
  OPT_nomultidefs = 1117,                    /* -nomultidefs */
  OPT_noprebind = 1118,                      /* -noprebind */
  OPT_noseglinkedit = 1119,                  /* -noseglinkedit */
  OPT_nostartfiles = 1120,                   /* -nostartfiles */
  OPT_nostdinc = 1121,                       /* -nostdinc */
  OPT_nostdinc__ = 1122,                     /* -nostdinc++ */
  OPT_nostdlib = 1123,                       /* -nostdlib */
  OPT_o = 1124,                              /* -o */
  OPT_object = 1125,                         /* -object */
  OPT_p = 1126,                              /* -p */
  OPT_pagezero_size = 1127,                  /* -pagezero_size */
  ...
  OPT_pie = 1132,                            /* -pie */
  OPT_pipe = 1133,                           /* -pipe */
  OPT_prebind = 1134,                        /* -prebind */
  OPT_prebind_all_twolevel_modules = 1135,   /* -prebind_all_twolevel_modules */
  OPT_preload = 1136,                        /* -preload */
  ...
  OPT_private_bundle = 1147,                 /* -private_bundle */
  OPT_pthread = 1148,                        /* -pthread */
  OPT_quiet = 1149,                          /* -quiet */
  OPT_r = 1150,                              /* -r */
  OPT_read_only_relocs = 1151,               /* -read_only_relocs */
  OPT_remap = 1152,                          /* -remap */
  OPT_s = 1153,                              /* -s */
  OPT_s_bc_abi = 1154,                       /* -s-bc-abi */
  OPT_save_temps = 1155,                     /* -save-temps */
  OPT_save_temps_ = 1156,                    /* -save-temps= */
  OPT_sectalign = 1157,                      /* -sectalign */
  OPT_sectcreate = 1158,                     /* -sectcreate */
  OPT_sectobjectsymbols = 1159,              /* -sectobjectsymbols */
  OPT_sectorder = 1160,                      /* -sectorder */
  OPT_seg1addr = 1161,                       /* -seg1addr */
  /* OPT_seg_addr_table = 1162, */           /* -seg_addr_table */
  /* OPT_seg_addr_table_filename = 1163, */  /* -seg_addr_table_filename */
  /* OPT_segaddr = 1164, */                  /* -segaddr */
  OPT_segcreate = 1165,                      /* -segcreate */
  OPT_seglinkedit = 1166,                    /* -seglinkedit */
  OPT_segprot = 1167,                        /* -segprot */
  /* OPT_segs_read_only_addr = 1168, */      /* -segs_read_only_addr */
  /* OPT_segs_read_write_addr = 1169, */     /* -segs_read_write_addr */
  OPT_shared = 1170,                         /* -shared */
  OPT_shared_libgcc = 1171,                  /* -shared-libgcc */
  /* OPT_single_module = 1172, */            /* -single_module */
  /* OPT_specs = 1173, */                    /* -specs */
  OPT_specs_ = 1174,                         /* -specs= */
  OPT_static = 1175,                         /* -static */
  ...
  OPT_static_libstdc__ = 1180,               /* -static-libstdc++ */
  /* OPT_std_c__03 = 1181, */                /* -std=c++03 */
  OPT_std_c__0x = 1182,                      /* -std=c++0x */
  ...
  OPT_std_gnu__0x = 1193,                    /* -std=gnu++0x */
  ...
  OPT_sub_library = 1205,                    /* -sub_library */
  OPT_sub_umbrella = 1206,                   /* -sub_umbrella */
  ...
  OPT_twolevel_namespace = 1214,             /* -twolevel_namespace */
  OPT_twolevel_namespace_hints = 1215,       /* -twolevel_namespace_hints */
  OPT_u = 1216,                              /* -u */
  /* OPT_umbrella = 1217, */                 /* -umbrella */
  OPT_undef = 1218,                          /* -undef */
  OPT_undefined = 1219,                      /* -undefined */
  /* OPT_unexported_symbols_list = 1220, */  /* -unexported_symbols_list */
  OPT_v = 1221,                              /* -v */
  OPT_version = 1222,                        /* -version */
  OPT_w = 1223,                              /* -w */
  /* OPT_weak_reference_mismatches = 1224, *//* -weak_reference_mismatches */
  OPT_whatsloaded = 1225,                    /* -whatsloaded */
  OPT_whyload = 1226,                        /* -whyload */
  OPT_wrapper = 1227,                        /* -wrapper */
  OPT_x = 1228,                              /* -x */
  OPT_y = 1229,                              /* -y */
  OPT_z = 1230,                              /* -z */
  N_OPTS,
